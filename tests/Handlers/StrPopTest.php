...
class StrPopTest extends TestCase
{
    const EMPTY_STRING          = '';
    ...
    /**
     * Test Str::pop() with different encodings
     *
    ...
    private function encodingTest(string $encoding)
    {
        ...
        $char1 = mb_convert_encoding('n', $encoding);
        $result1 = Str::pop($str1, $encoding);
        ...
        $char2 = mb_convert_encoding('а', $encoding);
        $result2 = Str::pop($str2, $encoding);
